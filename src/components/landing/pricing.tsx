        ...
        <div className="mx-auto max-w-lg offer-box">
          <Card className="bg-primary/5 p-6 md:p-8 rounded-xl text-center space-y-4 shadow-2xl border-2 border-secondary">
            ...
            <p className="text-md font-semibold text-muted-foreground">
              Leve tudo isso hoje (de{" "}
              <span className="line-through">R$ 348,00</span>) por apenas:
            </p>
            <p className="text-6xl font-extrabold text-primary current-price">
              R$ 27,90
            </p>
            <p className="font-semibold text-md -mt-2 installment">
